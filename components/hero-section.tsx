...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden bg-[#0F172A]">
      ...
      >
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight text-balance font-mono">
        ...
        <p className="text-base md:text-lg text-[#94A3B8] mb-8 max-w-2xl mx-auto text-pretty font-mono leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <Button
            size="lg"
            className="bg-[#8B5CF6] text-white font-mono font-semibold hover:bg-[#6D28D9] px-8 border border-[#A78BFA]/30"
